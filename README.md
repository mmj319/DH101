...
- 📄 **[Maddie's Resume](pages/resume.md)**
- 📺 **[Anime I've Watched & Love](index.html#anime)**
...
## 💻 Coursework
- **Weekly Reflections:** Browse [`reflections/`](reflections/) for reflections from Week 1 to Week 13.
- **Weekly Makes:** Browse [`makes/`](makes/) for critical making artifacts from Week 1 to Week 13.
- **AI Log:** Documented in [`ai-log/`](ai-log/).

---
*Created by Madison Jensen • Denison University Class of 2029*
